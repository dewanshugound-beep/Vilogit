  ...
  return (
    <main className="relative min-h-screen bg-background overflow-hidden noise-overlay">
      ...
      <div className="relative z-10 min-h-screen flex">
        {/* Left side - Branding */}
        <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 border-r border-foreground/10">
          ...
          <div className={`transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <h1 className="font-serif text-5xl lg:text-6xl tracking-tight mb-6">
              Sign in to<br />
              <span className="text-muted-foreground">continue building.</span>
            </h1>
            <p className="text-muted-foreground text-lg max-w-md leading-relaxed">
              Pick up where you left off. Your repos, your Vilos, your AI assistant — all waiting.
            </p>
          </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
          <div className={`w-full max-w-md transition-all duration-700 delay-150 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="mb-10">
              <h2 className="font-serif text-3xl tracking-tight mb-2">Sign in</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-xs text-muted-foreground link-underline">
                    Forgot password?
                  </Link>
                </div>
                <input
