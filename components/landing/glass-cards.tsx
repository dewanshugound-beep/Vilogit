  ...
  return (
    <>
      ...
      <div className="flex gap-2.5 bg-[rgba(255,107,0,0.06)] border border-[rgba(255,107,0,0.15)] rounded-xl p-3">
        <div className="w-8 h-8 rounded-full bg-[#FF6B00] overflow-hidden flex items-center justify-center shrink-0 border border-white/10 shadow-lg">
          <img src="/brand-logo.png" alt="V" className="w-full h-full object-cover scale-[2.2] translate-y-[1px]" />
        </div>
  ...
  return (
    <div className="flex flex-col gap-2.5">
      ...
      <div className="flex gap-2 items-start">
        <div className="w-7 h-7 rounded-full bg-[#FF6B00] overflow-hidden flex items-center justify-center shrink-0 border border-white/10 shadow-lg">
          <img src="/brand-logo.png" alt="V" className="w-full h-full object-cover scale-[2.2] translate-y-[1px]" />
        </div>
        <div>
